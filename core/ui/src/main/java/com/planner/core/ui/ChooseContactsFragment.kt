...
import com.planner.core.domain.ContactManager
import com.planner.core.ui.databinding.FragmentChooseContactsBinding
...
class ChooseContactsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            adapter.submitList(
                ContactManager.fetchContacts(requireContext(), requireActivity())
                    .toList(),
            )
        }
    }
